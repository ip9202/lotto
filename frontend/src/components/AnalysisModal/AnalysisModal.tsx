            ...
            <div>
              <div className="flex items-center justify-between mb-3">
                ...
                <div className="group relative">
                  ...
                  <div className="absolute top-6 left-1/2 w-80 bg-gray-900 text-white text-xs rounded-lg p-3 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 shadow-lg transform -translate-x-1/2">
                ...
                <div className="bg-blue-50 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="group relative">
                      ...
                      <div className="absolute top-5 left-1/2 w-56 bg-blue-900 text-white text-xs rounded-lg p-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 transform -translate-x-1/2">
                ...
                <div className="bg-green-50 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="group relative">
                      ...
                      <div className="absolute top-5 left-1/2 w-56 bg-green-900 text-white text-xs rounded-lg p-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 transform -translate-x-1/2">
                ...
                <div className="bg-purple-50 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="group relative">
                      ...
                      <div className="absolute top-5 left-1/2 w-56 bg-purple-900 text-white text-xs rounded-lg p-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 transform -translate-x-1/2">
                ...
                <div className="bg-orange-50 p-4 rounded-lg">
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="group relative">
                      ...
                      <div className="absolute top-5 left-1/2 w-56 bg-orange-900 text-white text-xs rounded-lg p-2 opacity-0 group-hover:opacity-100 transition-opacity pointer-events-none z-50 transform -translate-x-1/2">
